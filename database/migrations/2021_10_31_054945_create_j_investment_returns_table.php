...
class CreateJInvestmentReturnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('j_investment_returns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('j_investment_returns');
    }
}
