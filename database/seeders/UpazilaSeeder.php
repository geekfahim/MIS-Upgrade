...
class UpazilaSeeder extends Seeder
{
    ...
    public function run()
    {
        $upazilas = array(
            ...
            // City Corporation
            array('id' => '492', 'district_id' => '47', 'name' => 'Dhaka North City Corporation', 'bn_name' => 'ঢাকা সদর', 'url' => 'http://www.dncc.gov.bd/'),
            array('id' => '493', 'district_id' => '47', 'name' => 'Dhaka South City Corporation', 'bn_name' => 'ঢাকা সদর', 'url' => 'http://www.dhakasouthcity.gov.bd/'),
            array('id' => '494', 'district_id' => '41', 'name' => 'Gazipur City Corporation', 'bn_name' => 'গাজীপুর সদর', 'url' => 'http://gcc.gov.bd/'),
            array('id' => '495', 'district_id' => '43', 'name' => 'Narayanganj City Corporation', 'bn_name' => 'নারায়ণগঞ্জ সদর', 'url' => 'http://www.dhakasouthcity.gov.bd/'),
            array('id' => '496', 'district_id' => '33', 'name' => 'Barishal City Corporation', 'bn_name' => 'বরিশাল সদর', 'url' => 'www.barisal.gov.bd'),
            array('id' => '497', 'district_id' => '8', 'name' => 'Chittagong City Corporation', 'bn_name' => 'চট্টগ্রাম সদর', 'url' => 'http://www.ccc.gov.bd/'),
            array('id' => '498', 'district_id' => '1', 'name' => 'Cumilla City Corporation', 'bn_name' => 'কুমিল্লা সদর', 'url' => 'http://www.ccc.gov.bd/'),
            array('id' => '499', 'district_id' => '27', 'name' => 'Khulna City Corporation', 'bn_name' => 'খুলনা সদর', 'url' => 'http://www.khulnacity.org/'),
            array('id' => '500', 'district_id' => '62', 'name' => 'Mymensingh City Corporation', 'bn_name' => 'ময়মনসিংহ সদর', 'url' => 'http://www.mcc.gov.bd/'),
            array('id' => '501', 'district_id' => '15', 'name' => 'Rajshahi City Corporation', 'bn_name' => 'রাজশাহী সদর', 'url' => 'http://erajshahi.portal.gov.bd/'),
            array('id' => '502', 'district_id' => '36', 'name' => 'Sylhet City Corporation', 'bn_name' => 'সিলেট সদর', 'url' => 'http://www.scc.gov.bd/'),
            array('id' => '503', 'district_id' => '52', 'name' => 'Faridpur City Corporation', 'bn_name' => 'ফরিদপুর সদর', 'url' => 'http://www.fcc.gov.bd/'),
        );
        $maxCount = count($upazilas);
        for ($i = 0; $i < $maxCount; $i++) {
            $data[] = [
                'name' => $upazilas[$i]['name'],
                'district_id' => $upazilas[$i]['district_id'],
                'created_by' => 1,
                'created_at' => now()
            ];
        }
