                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Bank and Financial Institute</strong>
                                    <strong v-else>Update Bank and Financial Institute</strong>
                                </h6>
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Bank and Financial Institute Details</h6>
                            ...
                            <table class="table table-sm table-hover">
                                ...
                                <tr v-if="chunk.status">
                                    ...
                                    <td class="text-capitalize">
                                        <span v-if="chunk.status == 'active'" class="badge badge-success">
                                            {{ chunk.status }}
                                        </span>
                                        <span v-else-if="chunk.status == 'inactive'"
                                              class="badge badge-warning">{{ chunk.status }}</span>
