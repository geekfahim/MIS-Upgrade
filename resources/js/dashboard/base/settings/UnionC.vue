                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Union</strong>
                                    <strong v-else>Update Union</strong>
                                </h6>
                            </div>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-file-text-o"></i>
                                    ...
                                    <input v-model="formData.name" v-validate="'required|min:2|max:50'"
                                           ...
                                           data-vv-as="name"
                                           data-vv-name="name" placeholder="name"
                                           type="text">
                            ...
                            <div class="form-group">
                                <label class="czm-xs">Upazila<span class="text-danger">*</span></label>
                                <Select2 v-model="formData.upazila_id" v-validate="'required'" :options=upazilas
                                         :settings="upazilaSettings" data-vv-as="upazila" data-vv-name="upazila_id"
                                         data-vv-validate-on="change"/>
                                <div v-if="vvErrors.has('upazila_id')"
                                     :class="[(vvErrors.has('upazila_id') ? ' d-block' : '')]"
                                     class="invalid-feedback">
                                    {{ vvErrors.first('upazila_id') }}
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="table">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width:104px">Upazila</th>
                            <th class="sort" style=" width:104px" @click="onClickSortItems('created_at')">Created
                            </th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Union Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                ...
                                <tr v-if="chunk.upazila">
                                    <td>Upazila</td>
                                    <td>:</td>
                                    <td>{{ chunk.upazila.text }}</td>
                                </tr>
...
export default {
        ...
        onClickEdit(id) {
            ...
            axios.patch(_this.routes.one + "/" + id).then((res) => {
                if (res.data) {
                    ...
                    if (res.data.upazila) {
                        _this.upazilas.push(res.data.upazila);
                    }
                } else {
                    toastr.error(res.data.message, "Warning");
                }
    ...
    created() {
        let _this = this;
        _this.upazilaSettings.ajax.url = this.routes.upazilaSearch;
        _this.upazilaSettings.ajax.processResults = function (data) {
            return {
                results: data,
            };
        };
