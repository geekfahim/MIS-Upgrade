                ...
                <div class="row justify-content-center">
                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Upazila</strong>
                                    <strong v-else>Update Upazila</strong>
                                </h6>
                            </div>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-file-text-o"></i>
                            ...
                            <div class="form-group">
                                <label class="czm-xs">District<span class="text-danger">*</span></label>
                                <Select2 v-model="formData.district_id" v-validate="'required'" :options=districts
                                         :settings="districtSettings" data-vv-as="district" data-vv-name="district_id"
                ...
                <div class="table">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width:104px">District</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Upazila Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                ...
                                <tr v-if="chunk.district">
                                    <td>District</td>
                                    <td>:</td>
                                    <td>{{ chunk.district.text }}</td>
                                </tr>
