<template>
    <div class="position-relative">
        <div class="card-header">
            <i class="fa fa-list"></i>Approve Investment
                    ...
                    <div class="col-10">
                        <table class="table table-sm table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td class="font-weight-bold">Business Plan:</td>
                                <td>{{ chunk.business ? chunk.business.business_name : '' }}</td>
                            </tr>
                            <tr>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="cursor: pointer;" @click="onClickSortItems('name')">Family Name</th>
                            <th style="cursor: pointer;" @click="onClickSortItems('date')">Date</th>
                            <th style="cursor: pointer;">Reference</th>
                            <th style="cursor: pointer;" @click="onClickSortItems('confirmed_amount')">Confirmed
                                Amount
                            </th>
                            <th style="cursor: pointer;" @click="onClickSortItems('status')">Status</th>
                            <th style="cursor: pointer;" @click="onClickSortItems('approved_amount')">Approved Amount
                            </th>
                            <th style="cursor: pointer;" @click="onClickSortItems('created_by')">Created By</th>
                            <th style="cursor: pointer; width: 100px" @click="onClickSortItems('created_at')">Created
                            </th>
