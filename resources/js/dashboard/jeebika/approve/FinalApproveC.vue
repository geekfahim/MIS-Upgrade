<template>
    <div class="position-relative">
        <div class="card-header">
            <i class="fa fa-list"></i>Approve Final
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6 col-sm-8 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="d-block czm-xs" for="">Investment As Per Application<span class="text-danger">*</span></label>
                            <div class="form-check form-check-inline">
                                <input id="is_investment_as_per_application_true"
                                       v-model.number="formData.is_investment_as_per_application"
                                       class="form-check-input czm-xs" name="is_investment_as_per_application"
                                       type="radio" value="1"/>
                                <label class="form-check-label" for="is_investment_as_per_application_true">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input id="is_investment_as_per_application_false"
                                       v-model.number="formData.is_investment_as_per_application"
                                       class="form-check-input czm-xs" name="is_investment_as_per_application"
                                       type="radio" value="0"/>
                                <label class="form-check-label" for="is_investment_as_per_application_false">No</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input id="is_recommended_true" v-model.number="formData.is_recommended"
                                       class="form-check-input czm-xs" name="is_recommended" type="radio" value="1"/>
                        ...
                        <div class="form-group">
                            <label class="czm-xs">Tenure Of Business<span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                                <input v-model="formData.business_tenure"
                                       ...
                                       name="business_tenure" placeholder="business tenure"
                                       type="text"/>
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="formData.profit_status" v-validate="'required'"
                                ...
                                <option v-for="item in profitStatus" :key="item" :value="item">
                                    {{ item }}
                                </option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                                <textarea v-model="formData.investment_findings" v-validate="'min:2|max:998'"
                                          ...
                                          class="form-control form-control-sm rounded-0"
                                          data-vv-as="investment_findings"
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="cursor: pointer;" @click="onClickSortItems('j_business_plan_id')">Business Name
                            </th>
...
export default {
    ...
    methods: {
        ...
        getAll() {
            ...
            axios.post(_this.routes.list, _this.search).then((res) => {
                if (res.data) {
                    ...
                    _this.profitStatus = res.data.profitStatus;
        ...
        onClickView(item) {
            ...
            _this.formView = true;
            _this.formData = item;
            $("#date").datepicker("update", _this.formData.final_date);
