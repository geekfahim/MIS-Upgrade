<template>
    <div class="position-relative">
        <div class="card-header">
            <i class="fa fa-list"></i>Approve Savings
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-8 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input v-model="formData.approved_amount" v-validate="'required|min:2|numeric'"
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="sort" @click="onClickSortItems('collector_id')">Collected By</th>
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td>{{ item.collector_id ? item.collector.name : '' }}</td>
...
export default {
    ...
    methods: {
        ...
        onClickView(item) {
            ...
            _this.formData.collector_id = item.collector_id;
