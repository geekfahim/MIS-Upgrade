        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div v-show="formData.report_type==='summary'" class="row">
                        <div class="col-md-12">
                ...
                <div class="col-md-9">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th>
                                <span v-if="formData.report_type==='summary'">Family</span>
                            ...
                            <th v-if="formData.report_type==='summary'">Start Date</th>
                        ...
                        <tr v-for="(item, index) in paginate.data" :key="index">
                            <td>
                                ...
                                <input v-if="formData.report_type==='summary'"
                            ...
                            <td>
                                <label v-if="formData.report_type==='summary'" :for="'id-'+index">
                                    {{ item.session_heading }}
                                </label>
                            ...
                            <td v-if="formData.report_type==='summary'">
...
export default {
    ...
    methods: {
        ...
        searchNow() {
            ...
            _this.formData.ids = [];
            axios
                .post(_this.routes.searchHealthSessionByProjectId, _this.formData)
                .then((res) => {
                    if (res.data) {
        ...
        _checkValidDownload() {
            ...
            if (_this.checkedIds.length === 0) {
                flag = false;
                toastr.error("Please select a health session", "Error");
            }
            if (_this.formData.report_type === "") {
                flag = false;
                _this.errors.report_type = [];
