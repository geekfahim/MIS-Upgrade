<template>
    <div class="position-relative">
        <div class="card-header">
            <span v-if="!formView"><i class="fa fa-list"></i> Training Feedback</span>
            <span v-else><i class="fa fa-list"></i> Add Training Feedback</span>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 my-4">
                        <button :disabled="checkIds.length<=0" class="btn btn-xs btn-danger-gradient rounded-0 w-100"
                                @click="onClickStatus('no','f86c6b')">
                            <i aria-hidden="true" class="fa fa-user-times"></i> No
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="width: 120px; cursor: pointer; "
                                @click="onClickSortItems('is_training_real_life')">
                                Work in Trade
                            </th>
                        </tr>
                        </thead>
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td>{{ item.remarks }}</td>
                            <td>
                                <span v-if="item.is_training_real_life" class="badge badge-primary">Yes</span>
