                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Zone</strong>
                                    <strong v-else>Update Zone</strong>
                                </h6>
                            </div>
                            <div class="form-group">
                                <label class="czm-xs">Zone Name<span class="text-danger">*</span></label>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="sort" @click="onClickSortItems('name')">Zone Name</th>
                            <th>Manager</th>
                            <th style="cursor: pointer; width: 140px" @click="onClickSortItems('created_at')">Created
                            </th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Zone Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <tr v-if="chunk.name">
                                    <td style="width: 100px;">Zone Name</td>
