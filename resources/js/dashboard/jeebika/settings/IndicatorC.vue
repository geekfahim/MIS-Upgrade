                ...
                <div class="row justify-content-center">
                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Indicator</strong>
                                    <strong v-else>Update Indicator</strong>
                                </h6>
                            </div>
                            <div class="form-group">
                                <label class="czm-xs">Indicator Name<span class="text-danger">*</span></label>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-file-text-o"></i>
                            ...
                            <div class="form-group">
                                <label class="czm-xs">Program Type<span class="text-danger">*</span></label>
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                    <span class="input-group-text">
                      <i class="fa fa-arrow-circle-down"></i>
                                    ...
                                    <select v-model.number="formData.program_type" v-validate="'required'"
                                            :class="[(vvErrors.has('program_type') ? 'is-invalid' : '')]"
                                            class="form-control form-control-sm rounded-0"
                                            data-vv-as="program type"
                                            data-vv-name="program_type"
                                            data-vv-validate-on="change">
                                        <option value="">Select One</option>
                                        <option v-for="(item,index) in programTypes" :key="index" :value="item">
                                            {{ item }}
                                        </option>
                                    </select>
                                    <div v-show="vvErrors.has('program_type')" class="invalid-feedback">
                                        {{ vvErrors.first('program_type') }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-arrow-circle-down"></i>
                                    ...
                                    <select v-model="formData.type" v-validate="'required'"
                                            ...
                                            class="form-control form-control-sm rounded-0" data-vv-as="type"
                                            data-vv-name="type"
                                            data-vv-validate-on="change">
                                        <option value="">Select One</option>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-arrow-circle-down"></i>
                                    ...
                                    <select v-model.number="formData.status" v-validate="'required'"
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="sort" style="width: 250px" @click="onClickSortItems('name')">Indicator Name</th>
                            <th class="sort" @click="onClickSortItems('program_type')">Program Type</th>
                            <th class="sort" @click="onClickSortItems('type')">Type</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Indicator Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <tr v-if="chunk.name">
                                    <td style="width: 100px;">Indicator Name</td>
                                    <td style="width: 5px;">:</td>
                                    <td>{{ chunk.name }}</td>
                                </tr>
                                <tr v-if="chunk.program_type">
                                    <td>Program Type</td>
                                    <td>:</td>
                                    <td>{{ chunk.program_type }}</td>
                                </tr>
                                <tr v-if="chunk.type">
                                    <td>Type</td>
                                    <td>:</td>
                                    <td>
                                        <span v-if="chunk.type == 'Family'" class="badge badge-info">Family</span>
                                        <span v-else-if="chunk.type == 'Member'"
                                              class="badge badge-secondary">Member</span>
                                        <span v-else class="badge badge-warning">{{ chunk.type }}</span>
                                    </td>
                                </tr>
                                <tr v-if="chunk.status">
                                    ...
                                    <td>
                                        ...
                                        <span v-else style="color: #e55353"><i
        ...
        getAll() {
            ...
            axios.post(_this.routes.list, _this.search).then((res) => {
                if (res.data) {
                    ...
                    _this.programTypes = res.data.programTypes;
