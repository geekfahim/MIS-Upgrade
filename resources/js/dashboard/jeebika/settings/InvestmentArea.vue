<template>
    <div class="position-relative">
        <div class="card-header">
            <i class="fa fa-list"></i> Investment Area
                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Investment Area</strong>
                                    <strong v-else>Update Investment Area</strong>
                                </h6>
                            </div>
                            <div class="form-group">
                                <label class="czm-xs">Investment Area Name<span class="text-danger">*</span></label>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="sort" @click="onClickSortItems('name')">Investment Area Name</th>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Investment Area Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <tr v-if="chunk.name">
                                    <td style="width: 100px;">Investment Area Name</td>
