                ...
                <div class="row justify-content-center">
                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Area</strong>
                                    <strong v-else>Update Area</strong>
                                </h6>
                            </div>
                            <div class="form-group">
                                <label class="czm-xs">Area Name<span class="text-danger">*</span></label>
                    ...
                    <span class="input-group-text">
                      <i class="fa fa-file-text-o"></i>
                            ...
                            <div class="form-group">
                                <label class="czm-xs">Manager</label>
                                <Select2 v-model="formData.manager_id" :options="managers"
                                         :settings="{ width: '100%', allowClear: true }"
                                         data-vv-as="manager" data-vv-name="manager_id" data-vv-validate-on="change"/>
                            ...
                            <div class="form-group">
                                <label class="czm-xs">Zone <span class="text-danger">*</span></label>
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text">
                                    ...
                                    <select v-model="formData.j_zone_id" v-validate="'required'"
                                            :class="[vvErrors.has('j_zone_id') ? 'is-invalid' : '']"
                                            class="form-control form-control-sm rounded-0" data-vv-as="zone"
                                            data-vv-name="j_zone_id"
                                            data-vv-validate-on="change">
                                        <option value="">Select One</option>
                                        <option v-for="(item,index) in jZones" :key="index" :value="item.id">
                                            {{ item.name }}
                                        </option>
                                    </select>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="sort" @click="onClickSortItems('name')">Area Name</th>
                            <th>Manager</th>
                            <th>Zone</th>
                            <th class="sort" style="width: 250px" @click="onClickSortItems('created_at')">Created
                            </th>
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td>{{ item.j_zone ? item.j_zone.name : '' }}</td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Area Details</h6>
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <tr v-if="chunk.name">
                                    <td style="width: 100px;">Area Name</td>
                                    <td style="width: 5px;">:</td>
                                    <td>{{ chunk.name }}</td>
                                </tr>
                                <tr v-if="chunk.manager">
                                    <td style="width: 100px;">Manager</td>
                                    <td style="width: 5px;">:</td>
                                    <td>{{ chunk.manager.name }}</td>
                                </tr>
                                <tr v-if="chunk.j_zone">
                                    <td style="width: 100px;">Zone</td>
                                    <td style="width: 5px;">:</td>
                                    <td>{{ chunk.j_zone.name }}</td>
                                </tr>
        ...
        getAll() {
            ...
            axios.post(_this.routes.list, _this.search).then((res) => {
                if (res.data) {
                    ...
                    _this.managers = res.data.managers;
