    ...
    <div class="position-relative">
        ...
        <div class="card-body">
            <div>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr v-for="(item, index) in originalData.data" :key="index">
                            <td>
                                <input v-if="healthsession.status!=='Complete'" :id="'id-'+item.id"
                ...
                <div v-if="healthsession.status!=='Complete'" class="row justify-content-center">
...
export default {
    ...
    name: "Health-Session-Implementation.vue",
    props: {
        healthsession: {
            type: Object,
            required: true
    ...
    methods: {
        ...
        onClickStatus(status, color = '3085d6') {
            ...
            let _msg = (_status === 'complete') ? `<p style="color:#${color}">You want to ${_status} this health session.</p>You won't be able to revert this!`
            ...
            axios
                ...
                .then((res) => {
                    if (res.data) {
                        ...
                        _this.healthSessionStatus = res.data.healthSessionStatus;
            ...
            axios
                ...
                .then((res) => {
                    if (res.data) {
                        ...
                        _this.formData.session_method = res.data.training_methods === 1 ? 'online' : 'offline';
