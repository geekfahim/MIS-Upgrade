                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="row justify-content-center">
                            <label class="d-inline-block">
                                Showing
                                <select v-model="search.select" @change="projectFilterSelect()">
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td>{{ item.j_project ? item.j_project.name : '' }}</td>
...
export default {
    ...
    methods: {
        ...
        updateQueryParams(key, value) {
            ...
            let select =
                key == "select" ? value : !!parsed.select ? parsed.select : "";
