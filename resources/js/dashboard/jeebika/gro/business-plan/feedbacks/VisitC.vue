            ...
            <div v-show="formView">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6 col-sm-8 col-xs-12">
                        <form ref="visitForm" class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Visit</strong>
                                    <strong v-else>Confirmation Visit</strong>
                                </h6>
                            </div>
                    ...
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td>
                                ...
                                <span v-else-if="'Confirmed' === item.status"
                                      class="badge badge-primary">Confirmed</span>
                                <span v-else-if="'Approved' === item.status" class="badge badge-success">Approved</span>
                            ...
                            <td>
                                <span v-if="'Not Started' === item.business_status" class="badge badge-warning">Not Started</span>
                                <span v-else-if="'Started' === item.business_status"
                                      class="badge badge-primary">Started</span>
                                <span v-else-if="'In Profit' === item.business_status" class="badge badge-success">In Profit</span>
                                <span v-else-if="'In Loss' === item.business_status"
                                      class="badge badge-danger">In Loss</span>
                                <span v-else-if="'Capital Loss' === item.business_status" class="badge badge-danger">Capital Loss</span>
                                <span v-else-if="'Break Even' === item.business_status" class="badge badge-primary">Break Even</span>
                                <span class="text-capitalize" v-else>{{ item.status }}</span>
                            </td>
                            <td>
                                {{ item.visit_by.name }}
            ...
            <div class="modal-dialog modal modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Visit Details</h6>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-sm table-hover">
                                        ...
                                        <tr v-if="chunk.visit_date">
                                            <td>Visit Date</td>
                                            <td>:</td>
                                            <td>{{ chunk.visit_date | dateFormat }}</td>
                                        </tr>
                                        <tr v-if="chunk.visit_id">
                                            <td>Visit By</td>
                                            <td>:</td>
                                            <td>{{ chunk.visit_by.name }}</td>
                                        </tr>
                                        <tr>
                                            <td>Business Status</td>
                                            <td>:</td>
                                            <td>
                                                <span v-if="'Not Started' === chunk.business_status"
                                                      class="badge badge-warning">Not Started</span>
                                                <span v-else-if="'Started' === chunk.business_status"
                                                      class="badge badge-primary">Started</span>
                                                <span v-else-if="'In Profit' === chunk.business_status"
                                                      class="badge badge-success">In Profit</span>
                                                <span v-else-if="'In Loss' === chunk.business_status"
                                                      class="badge badge-danger">In Loss</span>
                                                <span v-else-if="'Capital Loss' === chunk.business_status"
                                                      class="badge badge-danger">Capital Loss</span>
                                                <span v-else-if="'Break Even' === chunk.business_status"
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <span v-if="'Pending' === chunk.status" class="badge badge-warning">Pending</span>
                                                <span v-else-if="'Confirmed' === chunk.status"
                                                      class="badge badge-primary">Confirmed</span>
                                                <span v-else-if="'Approved' === chunk.status"
...
export default {
    ...
    methods: {
        ...
        getAll() {
            ...
            _this.formData = {};
            _this.formData.visit_id = "";
            _this.formData.business_status = "";
