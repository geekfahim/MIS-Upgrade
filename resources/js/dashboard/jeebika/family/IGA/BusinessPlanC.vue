        ...
        <div class="card-header">
            ...
            <div class="card-header-actions p-0 m-0">
                <button v-if="!formView" class="btn btn-brand btn-sm btn-github" type="button" @click="addNew()">
                    ...
                    <span>Add New Single Business Plan</span>
                </button>
                <button v-else class="btn btn-brand btn-sm btn-github" type="button" @click="getAll()">
                    <i class="fa fa-list"></i>
                    <span>View All Single Business Plan</span>
                </button>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select v-model="formData.investment_return_type"
                                            ...
                                            <option value="">Select One</option>
                                            <option v-for="item in investmentReturnTypes" :key="item"
                                                    :value="item">{{ item }}
                                            </option>
                                        </select>
                        ...
                        <div class="source">
                            <div class="form-group row justify-content-between my-4">
                                <h6 class="">
                                    <strong>Source of Capital</strong>
                                </h6>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm table-stripe">
                                            ...
                                            <tr v-for="(item,index) in sourceCapitals" :key="index">
                                                <td class="text-capitalize">{{ item.source_name }}</td>
                                                <td class="text-capitalize tk">{{ item.source_amount }}</td>
                                                <td class="text-capitalize">{{ item.source_remarks }}</td>
                                                <td>
                                                    <button class="btn btn-xs btn-danger rounded-0"
                                                            @click="requestRemoveSourceCapital(item.source_name,index)">
                                        ...
                                        <small class="text-danger">
                                            * {{ maxCount - sourceCapitals.length }} Source Capital remaining!
                                        </small>
                                    </div>
                                </div>
                            </div>
                            <form v-if="maxCount != sourceCapitals.length" data-vv-scope="v_scope"
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="czm-xs">Source Name <span class="text-danger">*</span></label>
                                            <select v-model.number="sourceData.source_name"
                                                    v-validate="'required'"
                                                    :class="[(vvErrors.has('v_scope.source_name') ? 'is-invalid' : '')]"
                                                    class="form-control form-control-sm" data-vv-as="source name"
                                                    data-vv-name="source_name">
                                                <option value="">Select One</option>
                                                <option v-for="item in sourceCapitalTypes" :key="item"
                                                        :value="item">{{ item }}
                                                </option>
                                            </select>
                                            <div v-show="vvErrors.has('v_scope.source_name')" class="invalid-feedback">
                                                {{ vvErrors.first('v_scope.source_name') }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-md-12">
                                        <button class="btn btn-brand btn-sm btn-czm-green" type="submit">
                                            <i class="fa fa-plus"></i><span>Add Source</span>
                                        </button>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select v-model="fieldData.field_name" v-validate="'required'"
                                                ...
                                                <option value="">Select One</option>
                                                <option v-for="item in fieldCapitalTypes" :key="item"
                                                        :value="item">{{ item }}
                                                </option>
                                            </select>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr v-for="(item, index) in outputRes.data" :key="index">
                            ...
                            <td><span class="tk"></span>{{ item.business_seed_money }}</td>
                            <td>
                ...
                <div v-if="chunk" class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div style="font-weight:bold">Source Capitals</div>
                                <div class="customCSS table-responsive border">
                                    <table class="table table-responsive-sm table-sm">
                                        <thead>
                                        <tr>
                                            <th style="width: 250px">Source Name</th>
                                            <th>Source Amount</th>
                                            <th>Source Remarks</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr v-for="(item, index) in chunk.sources" :key="index">
                                            <td>{{ item.source_name }}</td>
                                            <td>{{ item.source_amount }}</td>
                                            <td>{{ item.source_remarks }}</td>
                                        </tr>
                                        <tr v-if="chunk.sources.length === 0">
                            ...
                            <div v-if="'Pending' !== chunk.meeting_status" class="col-md-12">
                                ...
                                <div class="customCSS table-responsive border">
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <tr>
                                            <td>Disbursment Date: {{ chunk.disbursement_date | dateFormat }}</td>
                                            <td>Disbursment Amount:<span v-if="chunk.disbursement_amount" class="tk">{{
