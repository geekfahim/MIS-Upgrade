                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Miscellaneous</strong>
                                    <strong v-else>Confirmation Miscellaneous</strong>
                                </h6>
                            </div>
            ...
            <div class="modal-dialog modal modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Miscellaneous Details</h6>
...
export default {
    ...
    created() {
        ...
        this.search.sort = !!parsed.sort ? parsed.sort : "date";
