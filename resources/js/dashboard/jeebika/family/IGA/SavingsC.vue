                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Savings</strong>
                                    <strong v-else>Confirmation Savings</strong>
                                </h6>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    <input v-model.number="formData.confirmed_amount" v-validate="'required|numeric'"
                                           ...
                                           data-vv-as="saving amount"
                                           data-vv-name="confirmed_amount"
                                           name="confirmed_amount"
                                           placeholder="saving amount" type="text"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    <textarea v-model="formData.remarks" v-validate="'name_with_number|min:2|max:998'"
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th>Collection By</th>
                            <th class="sort" style="width: 140px" @click="onClickSortItems('status')">Status</th>
                            ...
                            <th style="width:165px; text-align:center">Action</th>
                        </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-dialog modal modal-dialog-centered" role="document">
                <div v-if="chunk" class="modal-content rounded-0">
                    <div class="modal-header">
                        <h6 id="exampleModalCenterTitle" class="modal-title">Savings Details</h6>
