                        ...
                        <form class="form-horizontal" v-on:submit.prevent="onSubmit">
                            <div class="form-group row justify-content-center">
                                <h6 class="text-left col-sm-12">
                                    <strong v-if="createView">Add New Investment</strong>
                                    <strong v-else>Confirmation Investment</strong>
                                </h6>
                            </div>
                            <div class="form-group">
                                <label class="czm-xs">Reference Number</label>
                                <div class="input-group input-group-sm">
                                    <input v-model="formData.reference_number" v-validate="'min:2|name_with_number'"
                                           :class="[this.vvErrors.has('reference_number') ? 'is-invalid' : '',]"
                                           autocomplete="off"
                                           class="form-control form-control-sm rounded-0"
                                           data-vv-as="reference number"
                                           data-vv-name="reference_number"
                                           placeholder="reference number" type="text"/>
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="formData.j_business_plan_id" v-validate="'required'"
                                    ...
                                    <option v-for="(item,index) in businessApplication" :key="index" :value="item.id">
                                        {{ item.business_name }}
                                    </option>
                                </select>
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th style="cursor: pointer" @click="onClickSortItems('date')">Date</th>
                            <th>Reference</th>
                            <th>Business Plan</th>
                            <th class="sort" @click="onClickSortItems('confirmed_amount')">Confirmed Amount
                            </th>
                            <th class="sort" @click="onClickSortItems('status')">
                                Status
                            </th>
                            <th class="sort" @click="onClickSortItems('approved_amount')">Approved Amount
                            </th>
                            <th style="width: 140px" @click="onClickSortItems('created_at')">Created
                            </th>
        ...
        getAll() {
            ...
            axios.post(_this.routes.list, _this.search).then((res) => {
                if (res.data) {
                    ...
                    _this.businessApplication = res.data.businessApplication;
