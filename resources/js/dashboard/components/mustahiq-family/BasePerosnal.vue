    ...
    <div>
        <div class="row no-gutters">
            <div class="col-md-3">
                <div class="p-1">
                    <div class="card-header p-1">
                        Representative's Picture (max:150kb)
                        <span class="card-header-actions pr-1">
                            <button class="btn btn-danger btn-xs"
                                    @click="removePicture()"> Remove</button>
                        </span>
                    </div>
                    <div class="border w-100 h-custom" @click="chooseFilePicture()">
                        <img :src="picturePreview" class="custom-image"/>
                    </div>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="is_earn_ability_true" v-model="formData.is_earn_ability"
                                   class="form-check-input"
                                   name="is_earn_ability" type="radio" value="true"/>
                            <label class="form-check-label" for="is_earn_ability_true">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="is_earn_ability_false" v-model="formData.is_earn_ability"
                                   class="form-check-input"
                                   name="is_earn_ability" type="radio" value="false"/>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <Select2 v-model="formData.vocational_trainings_have"
                                 :options="initData.vocationals"
                                 :settings="{ width: '100%', allowClear: true, multiple: true }"
                                 data-vv-as="vocational trainings have"
                                 data-vv-name="vocational_trainings_have"/>
                        <div v-if="vvErrors.has('vocational_trainings_have')"
                             :class="[(vvErrors.has('vocational_trainings_have') ? ' d-block' : '')]"
                             class="invalid-feedback">
                            {{ vvErrors.first('vocational_trainings_have') }}
                        </div>
                    </div>
                </div>
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <Select2 v-model="formData.vocational_trainings_need"
                                 :options="initData.vocationals"
                                 :settings="{ width: '100%', allowClear: true, multiple: true }"
                                 data-vv-as="vocational trainings need"
                                 data-vv-name="vocational_trainings_need"/>
                        <div v-if="vvErrors.has('vocational_trainings_need')"
                             :class="[(vvErrors.has('vocational_trainings_need') ? ' d-block' : '')]"
                             class="invalid-feedback">
                            {{ vvErrors.first('vocational_trainings_need') }}
                        </div>
                    </div>
                </div>
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <Select2 v-model="formData.skill_trainings_have"
                                 :options="initData.skills"
                                 :settings="{ width: '100%', allowClear: true, multiple: true }"
                                 data-vv-as="skill trainings have"
                                 data-vv-name="skill_trainings_have"/>
                        <div v-if="vvErrors.has('skill_trainings_have')"
                             :class="[(vvErrors.has('skill_trainings_have') ? ' d-block' : '')]"
                             class="invalid-feedback">
                            {{ vvErrors.first('skill_trainings_have') }}
                        </div>
                    </div>
                </div>
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <Select2 v-model="formData.skill_trainings_need"
                                 :options="initData.skills"
                                 :settings="{ width: '100%', allowClear: true, multiple: true }"
                                 data-vv-as="skill trainings need"
                                 data-vv-name="skill_trainings_need"/>
                        <div v-if="vvErrors.has('skill_trainings_need')"
                             :class="[(vvErrors.has('skill_trainings_need') ? ' d-block' : '')]"
                             class="invalid-feedback">
                            {{ vvErrors.first('skill_trainings_need') }}
                        </div>
                    </div>
                </div>
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.marital_status"
                            ...
                            <option v-for="(item,index) in initData.maritalStatuses" :key="index"
                                    :value="index">
                                {{ item }}
                            </option>
                        </select>
                        ...
                        <div class="bg-gray-100">
                            ...
                            <div class="form-check form-check-inline">
                                <select v-model.number="formData.spouse_living_status"
                                    ...
                                    <option v-for="(item,index) in initData.relationalLivingStatus" :key="index"
                                            :value="index">
                                        {{ item }}
                                    </option>
                                </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.highest_education_level"
                            ...
                            <option v-for="(item,index) in initData.educationLevels" :key="index"
                                    :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.blood_group"
                            ...
                            <option v-for="(item,index) in initData.bloodGroups" :key="index" :value="index">
                                {{ item }}
                            </option>
                        </select>
            ...
            <div class="col-md-3">
                <div class="p-1">
                    <div class="bg-gray-100">
                        <label class="mb-0 pl-1">Representative's Full Name(As Certificate)<span
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.gender" v-validate="'required'"
                            ...
                            <option v-for="(item,index) in initData.genders" :key="index" :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div v-show="2 === formData.gender && 1 !== formData.marital_status"
                    ...
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.pregnancy_status" v-validate="'required'"
                            ...
                            <option v-for="(item,index) in initData.pregnancyStatuses" :key="index"
                                    :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        <div class="form-check form-check-inline">
                            <input id="inlineRadio3" ref="birthAndAge" v-model="formData.is_birth_date"
                                   class="form-check-input" name="inlineRadioOptions1" type="radio" value="true"
                                   @change="checkBirthDate"/>
                            <label class="form-check-label" for="inlineRadio3">Date of Birth<span
                                class="text-danger">*</span></label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="inlineRadio4" v-model="formData.is_birth_date" class="form-check-input"
                                   name="inlineRadioOptions1" type="radio" value="false" @change="checkBirthDate"/>
                ...
                <div class="row no-gutters p-1">
                    <div class="col-md-6">
                        <input id="birth_date" v-model="formData.birth_date"
                               v-validate="'required_if:birthAndAge,true|date_format:yyyy-mm-dd'"
                               :class="[this.vvErrors.has('birth_date') ? 'is-invalid' : '']"
                               :disabled="'false' === formData.is_birth_date" autocomplete="off"
                    ...
                    <div class="col-md-6">
                        <input id="age" v-model.number="formData.age"
                               v-validate="'required_if:birthAndAge,false|numeric|max_value:150'"
                               :class="[this.vvErrors.has('age') ? 'is-invalid' : '']"
                               :disabled="'true' === formData.is_birth_date"
                               class="form-control form-control-sm rounded-0"
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.religion" v-validate="'required'"
                            ...
                            <option value="">Select One</option>
                            <option v-for="(item,index) in initData.religions" :key="index" :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="is_orphan_true" v-model="formData.is_orphan" class="form-check-input"
                                   name="is_orphan" type="radio" value="true"/>
                            <label class="form-check-label" for="is_orphan_true">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="is_orphan_false" v-model="formData.is_orphan" class="form-check-input"
                                   name="is_orphan" type="radio" value="false"/>
                            <label class="form-check-label" for="is_orphan_false">No</label>
                        </div>
                    </div>
                </div>
                <div v-show="'true' === formData.is_orphan" class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.orphan_type"
                            ...
                            <option value="">Select One</option>
                            <option v-for="(item,index) in initData.orphanTypes" :key="index" :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        <label class="mb-0 pl-1">Representative's Mobile</label>
                        <div class="input-group">
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="input-group">
                            ...
                            <input v-model="formData.alternate_mobile" v-validate="'numeric|mobile'"
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="input-group">
                            ...
                            <input v-model="formData.emergency_mobile" v-validate="'numeric|mobile'"
            ...
            <div class="col-md-3">
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <select v-model.number="formData.relation_with_family_head" v-validate="'required'"
                                ...
                                class="form-control form-control-sm rounded-0"
                                data-vv-as="Relation with Family Representative"
                                data-vv-name="relation_with_family_head">
                            <option value="">Select One</option>
                            <option v-for="(item,index) in computeRelations" :key="index" :value="index">
                                {{ item }}
                            </option>
                        </select>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        <label class="mb-0 pl-1">Representative Occupation</label>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        <label class="mb-0 pl-1">Representative Monthly Income</label>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="healthRadioOptionsYes" v-model="formData.is_disease"
                                   class="form-check-input"
                                   name="healthRadioOptions" type="radio" value="true" @change="checkHealthCondition"/>
                            <label class="form-check-label" for="healthRadioOptionsYes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="healthRadioOptionsNo" v-model="formData.is_disease"
                                   class="form-check-input"
                                   name="healthRadioOptions" type="radio" value="false" @change="checkHealthCondition"/>
                            <label class="form-check-label" for="healthRadioOptionsNo">No</label>
                        </div>
                    </div>
                </div>
                <div v-show="diseaseFlag" class="p-1">
                    <div class="bg-gray-100">
                    ...
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="is_disease_regular_medicine_true"
                                   v-model="formData.is_disease_regular_medicine" class="form-check-input"
                                   name="is_disease_regular_medicine" type="radio" value="true"/>
                            <label class="form-check-label" for="is_disease_regular_medicine_true">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="is_disease_regular_medicine_false"
                                   v-model="formData.is_disease_regular_medicine" class="form-check-input"
                                   name="is_disease_regular_medicine" type="radio" value="false"/>
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="inlineRadio1" v-model="formData.is_disability" class="form-check-input"
                                   name="inlineRadioOptions" type="radio" value="true" @change="checkDisability"/>
                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="inlineRadio2" v-model="formData.is_disability" class="form-check-input"
                                   name="inlineRadioOptions" type="radio" value="false" @change="checkDisability"/>
                            <label class="form-check-label" for="inlineRadio2">No</label>
                        </div>
                    </div>
                </div>
                <div v-show="disabilityFlag" class="p-1">
                    <div class="bg-gray-100">
            ...
            <div class="col-md-3">
                ...
                <div class="p-1">
                    <div class="bg-gray-100">
                        ...
                        <div class="form-check form-check-inline">
                            <input id="addressRadioOptionsYes" v-model="formData.is_present_as_permanent"
                                   class="form-check-input" name="addressRadioOptions" type="radio" value="true"
                                   @change="checkAddress"/>
                            <label class="form-check-label" for="addressRadioOptionsYes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input id="addressRadioOptionsNo" v-model="formData.is_present_as_permanent"
                                   class="form-check-input" name="addressRadioOptions" type="radio" value="false"
                                   @change="checkAddress"/>
                            <label class="form-check-label" for="addressRadioOptionsNo">No</label>
                        </div>
                    </div>
                </div>
                <div v-if="!formData.is_present_as_permanent">
                    <div class="p-1">
                        <div class="bg-gray-100">
                    ...
                    <div class="p-1">
                        <div class="bg-gray-100">
                            ...
                            <select v-model.number="formData.permanent_district_id"
                                ...
                                <option value="">Select One</option>
                                <option v-for="(item,index) in initData.districts" :key="index"
                                        :value="item.id">
                                    {{ item.name }}
                                </option>
                            </select>
...
export default {
    ...
    data() {
        return {
            ...
            formData: {
                ...
                marital_status: 1,
                spouse_name: "",
                spouse_living_status: 1,
                highest_education_level: 1,
                vocational_trainings_have: [],
                vocational_trainings_need: [],
                skill_trainings_have: [],
                skill_trainings_need: [],
                ...
                reference_number: "",
                father_name: "",
                father_living_status: 1,
                mother_name: "",
                mother_living_status: 1,
                relation_with_family_head: 1,
                occupation_id: "",
                monthly_income: "",
                remarks: "",
                is_disability: 'false',
    ...
    methods: {
        removeMustahiq(item, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.formData.mustahiqs.splice(index, 1);
                }
            });
        },
        _newMustahiqObject(data) {
            let mustahiq = {};
            for (let key in data) {
        ...
        _resetFormData() {
            ...
            this.formData.alternate_mobile = "";
            this.formData.emergency_mobile = "";
            this.formData.marital_status = 1;
            this.formData.spouse_name = "";
            this.formData.spouse_living_status = 1;
            this.formData.highest_education_level = 1;
            this.formData.vocational_trainings_have = [];
            this.formData.vocational_trainings_need = [];
            this.formData.skill_trainings_have = [];
            this.formData.skill_trainings_need = [];
            this.formData.is_earn_ability = 'false';
            this.formData.name = "";
            this.formData.gender = "";
            this.formData.pregnancy_status = 1;
            this.formData.is_birth_date = 'true';
            this.formData.birth_date = "";
            $("#birth_date").datepicker("update", "");
            this.formData.age = "";
            this.formData.is_orphan = 'false';
            this.formData.religion = "";
            this.formData.orphan_type = "";
            this.formData.blood_group = 1;
            this.formData.email = "";
            this.formData.nid = "";
            this.formData.passport = "";
            this.formData.birth_certificate = "";
            this.formData.reference_number = "";
            this.formData.father_name = "";
            this.formData.father_living_status = 1;
            this.formData.mother_name = "";
            this.formData.mother_living_status = 1;
            this.formData.relation_with_family_head = "";
            this.formData.occupation_id = "";
            this.formData.monthly_income = "";
            this.formData.remarks = "";
            this.formData.is_disability = 'false';
            this.formData.disability_id = "";
            this.formData.is_disease = 'false';
            this.formData.disease_id = "";
            this.formData.is_disease_regular_medicine = 'false';
            this.formData.present_address = "";
            this.formData.present_district_id = "";
            this.formData.present_upazila_id = "";
            this.formData.present_union_id = "";
            this.formData.present_post_code = "";
            this.formData.is_present_as_permanent = 'true';
            this.formData.permanent_address = "";
            this.formData.permanent_district_id = "";
            this.formData.permanent_union_id = "";
            this.formData.permanent_upazila_id = "";
            this.formData.permanent_post_code = "";
            this.checkDisability();
            this.checkHealthCondition();
            this.checkBirthDate();
        ...
        addMustahiq() {
            ...
            _this.$validator.validateAll().then((result) => {
                if (result) {
                    this.$emit('mustahiq-add', this._newMustahiqObject(this.formData));
                    _this._resetFormData();
                }
            });
        },
        getUpazila(key) {
            ...
            axios.post(this.routes.upazilaSearch, {district_id: id,})
                .then((res) => {
                    if (res.data) {
                        if ("permanent" == key) {
        ...
        getUnion(key) {
            ...
            axios.post(this.routes.unionSearch, {upazila_id: id,}).then((res) => {
                if (res.data) {
                    if ("permanent" == key) {
        ...
        checkDisability() {
            let _this = this;
            _this.disabilityFlag = _this.formData.is_disability == "true";
        },
        checkHealthCondition() {
            let _this = this;
            _this.diseaseFlag = _this.formData.is_disease == "true";
        },
        checkBirthDate() {
            let _this = this;
            _this.birthDayFlag = _this.formData.is_birth_date == "true";
        },
        checkAddress() {
            let _this = this;
            _this.formData.is_present_as_permanent =
                _this.formData.is_present_as_permanent == "true";
            ...
            if ("true" == _this.formData.is_present_as_permanent) {
                _this.formData.permanent_address =
    ...
    computed: {
        computeRelations() {
            let flag = false;
            let types = this.initData.familyRelationTypes;
            if (Array.isArray(this.formData.mustahiqs) && this.formData.mustahiqs.length > 0) {
                flag = this.formData.mustahiqs.some(item => 1 == item.relation_with_family_head);
            }
            return flag ? Object.keys(types).filter(key => key != 1).reduce((res, key) => (res[key] = types[key], res), {}) : types;
        }
    },
    filters: {
        dateFormat(value) {
