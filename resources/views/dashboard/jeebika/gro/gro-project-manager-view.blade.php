    ...
    <main class="main">
        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <div class="card card-accent-info" id="gro-project-manager-view-app">
                    <gro-project-manager-view-app></gro-project-manager-view-app>
                </div>
            </div>
        </div>
    </main>
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/gro/gro-project-manager-view.js") }}"></script>
@endpush
