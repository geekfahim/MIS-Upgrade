...
@section('title', 'Family Reports | Jeebika')
@push('header')
    ...
    <script>
        window.appHelper = {
            routes: {
                ...
                download: "{!! route('reports.family.create') !!}"
            }
        }
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <div class="card card-accent-info" id="family-report">
...
<script src="{{ asset("assets/js/dashboard/jeebika/reports/family-report.js") }}"></script>
@endpush
