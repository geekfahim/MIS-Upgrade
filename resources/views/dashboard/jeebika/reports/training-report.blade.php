...
@section('title', 'Training Reports | Jeebika')
@push('header')
    ...
    <script>
        window.appHelper = {
            routes: {
                ...
                searchTrainingByProjectId: "{!! route('reports.training.list') !!}",
                searchFamilies: "{!! route('reports.families.search') !!}",
                download: "{!! route('reports.training.create') !!}"
            }
        }
    </script>
@endpush
    ...
    <main class="main">
        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <div class="card card-accent-info" id="training-report">
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/reports/training-report.js") }}"></script>
@endpush
