...
@section('title', 'Implementation Plan Create | '.$project->name)
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{{ route('jeebika.implementation_create.view__list',['pid'=>$project->id]) }}",
                create: "{{ route('jeebika.implementation_create.view',['pid'=>$project->id]) }}"
            }
        };
    </script>
@endpush
...
@section("content")
    <main class="main">
        <div class="row no-gutters">
            <div class="col-md-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Implementation Plan Create</li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="implementation-plan-create-app">
                <implementation-plan-create-app :project="{{ $project }}"></implementation-plan-create-app>
            </div>
        </div>
    </main>
@endsection
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/project/implementation-plan-create.js") }}"></script>
@endpush
