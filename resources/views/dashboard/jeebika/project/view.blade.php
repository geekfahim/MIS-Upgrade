                        ...
                        <a href="{{ route('jeebika.mustahiq_view.view__list') }}" target="_blank">
                            <div class="card overflow-hidden">
                                <div class="card-body p-0 d-flex align-items-center">
                                    ...
                                    <div>
                                        <div
                                            class="fs-6 fw-semibold text-danger">{{getProjectDisableMustahiqCount()}}</div>
                                        <div class="text-medium-emphasis text-uppercase fw-semibold small">
                    ...
                    <div class="card overflow-hidden">
                        <a href="{{ url('jeebika/project/1/ip-feedback') }}">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div>
                                    <div class="fs-6 fw-semibold text-warning">{{getProjectAllActivitiesCount()}}</div>
                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
                                        All Activities
                                    </div>
                                </div>
                    ...
                    <div class="card overflow-hidden">
                        <a href="{{ url('jeebika/project/1/ip-feedback') }}">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div>
                                    <div
                                        class="fs-6 fw-semibold text-primary">{{getProjectActivitiesMonthlyCount()}}</div>
                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
                    ...
                    <div class="card overflow-hidden">
                        <a href="{{ url('jeebika/project/1/ip-feedback') }}">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div>
                                    <div
                                        class="fs-6 fw-semibold text-primary">{{getProjectActivitiesMonthlyCount(\App\Enums\JImplementationPlanStatus::Pending)}}</div>
                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
                    ...
                    <div class="card overflow-hidden">
                        <a href="{{ url('jeebika/project/1/ip-feedback') }}">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div>
                                    <div
                                        class="fs-6 fw-semibold text-warning">{{getProjectActivitiesMonthlyCount(\App\Enums\JImplementationPlanStatus::Implemented)}}</div>
                                    <div class="text-medium-emphasis text-uppercase fw-semibold small">
