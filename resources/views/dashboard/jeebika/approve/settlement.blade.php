...
@section('title', 'Settlement | Approve')
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{!! route('jeebika.settlement_approve.view', ['pid' => $project->id]) !!}",
                list: "{!! route('jeebika.settlement_approve.view__list', ['pid' => $project->id]) !!}"
            }
        };
    </script>
@endpush
...
@section("content")
    <main class="main">
        <div class="row no-gutters">
            <div class="col-md-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Settlement Approve</li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="settlement-approve-app">
                <settlement-approve-app></settlement-approve-app>
            </div>
        </div>
    </main>
@endsection
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/approve/settlement-approve.js") }}"></script>
@endpush
