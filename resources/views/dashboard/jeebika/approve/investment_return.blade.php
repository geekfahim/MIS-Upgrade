...
@section('title', 'Investment Return | Approve')
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{!! route('jeebika.investment_return_approve.view', ['pid' => $project->id]) !!}",
                list: "{!! route('jeebika.investment_return_approve.view__list', ['pid' => $project->id]) !!}"
            }
        };
    </script>
@endpush
...
@section("content")
    <main class="main">
        <div class="row no-gutters">
            <div class="col-md-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Investment Return Approve</li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="investment-return-approve-app">
                <investment-return-approve-app></investment-return-approve-app>
            </div>
        </div>
    </main>
@endsection
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/approve/investment-return-approve.js") }}"></script>
@endpush
