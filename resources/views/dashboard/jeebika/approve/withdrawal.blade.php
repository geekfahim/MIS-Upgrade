...
@section('title', 'Withdrawal | Approve')
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{!! route('jeebika.withdrawal_approve.view', ['pid' => $project->id]) !!}",
                list: "{!! route('jeebika.withdrawal_approve.view__list', ['pid' => $project->id]) !!}"
            }
        };
    </script>
@endpush
...
@section("content")
    <main class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="withdrawal-approve-app">
                <withdrawal-approve-app></withdrawal-approve-app>
            </div>
        </div>
    </main>
@endsection
...
@push("footer")
    ...
    <script src="{{ asset("assets/js/dashboard/jeebika/approve/withdrawal-approve.js") }}"></script>
@endpush
