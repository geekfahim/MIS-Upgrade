...
@section('title', 'Joint Business Plan  | ' . $family->name)
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{{ route('jeebika.business_plan_joint.view', ['fid' => $family->id]) }}",
                list: "{{ route('jeebika.business_plan_joint.view__list',['fid' => $family->id]) }}",
            }
        };
    </script>
...
@section('content')
    <main class="main">
        <div class="row no-gutters">
            <div class="col-md-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Joint Business Plan</li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="business-plan-joint-app">
                <business-plan-joint></business-plan-joint>
            </div>
        </div>
    </main>
@endsection
...
@push('footer')
    ...
    <script src="{{ asset('assets/js/dashboard/jeebika/family/IGA/business-plan-joint.js') }}"></script>
@endpush
