...
@section('title', 'Bank Charge | ' . $family->name)
@push('header')
...
@push('scripts')
    <script>
        window.appHelper = {
            routes: {
                one: "{{ route('jeebika.bank_charge.view', ['fid' => $family->id]) }}",
                list: "{{ route('jeebika.bank_charge.view__list', ['fid' => $family->id]) }}",
            }
        };
    </script>
...
@section('content')
    <main class="main">
        <div class="row no-gutters">
            <div class="col-md-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Bank Charge</li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-accent-info" id="bank-charge">
                <bank-charge :gro="{{ $family }}"></bank-charge>
            </div>
        </div>
    </main>
@endsection
...
@push('footer')
    ...
    <script src="{{ asset('assets/js/dashboard/jeebika/family/IGA/bank-charge.js') }}"></script>
@endpush
