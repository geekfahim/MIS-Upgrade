...
class JInvestmentReturn extends Model
{
    ...
    protected $casts = [
        ...
        'approved_amount' => 'int',
        'status' => JInvestmentReturnStatus::class,
    ...
    {
        return ['id', 'date', 'status', 'confirmed_amount', 'approved_amount', 'j_business_plan_id', 'created_at'];
    }
